...
class TestBord {
	...
	public void testConstructor() {
		...
		assertEquals(4 * Regler.MAKS_KORT_FARGE, bord.getBunkeFra().getAntallKort());
		assertEquals(0, bord.getBunkeTil().getAntallKort());
	...
	public void TestsnuBunken() {
		...
		int bunkefraantall = bunkeFra.getAntallKort();
		...
		assertEquals(1, bunkeTil.getAntallKort());
		assertEquals(overst, bunkeTil.seSiste());
		assertEquals(bunkefraantall, bunkeFra.getAntallKort());
